function compare-nsArray {
    ...
    while ($arraySpotCounter -lt $newArrayLength) {
        ...
        $initialArrayItemMatch = find-nsInArray `
        ...
        $newArrayItemTypeCheck = (get-nsType -passedObject $newArrayItem)
        $initialArrayItemTypeCheck = (get-nsType -passedObject $initialArrayItemMatch)
    ...
    while ($arraySpotCounter -lt $initialArrayLength) {
        ...
        $recursionNeeded = $(  (get-nsType -passedObject $initialArrayItem) -eq "array"  )
...
$initial = `
    @(
        ...
        @("secondArray1", "secondArray2", @("nestedArray1","nestedArray3"), @("nestedArray3","nestedArray4"))
     )
